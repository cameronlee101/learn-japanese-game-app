...
describe('Navigation', () => {
  ...
  it('navigate to flashcard activity, and go back and forth in the browser\'s history', () => {
    ...
    cy.location('pathname').should('include', 'selection')
    cy.location('pathname').should('include', 'flashcards-activity')
    ...
    cy.go('back')
    cy.location('pathname').should('not.include', 'selection')
    cy.location('pathname').should('not.include', 'flashcards-activity')
  ...
  it('navigate to multiple choice quiz activity, then go back to home', () => {
    ...
    cy.location('pathname').should('include', 'selection')
    cy.location('pathname').should('include', 'mc-quiz')
    ...
    cy.get('a').contains('Home').click()
    cy.location('pathname').should('not.include', 'selection')
    cy.location('pathname').should('not.include', 'mc-quiz')
  })
  ...
  it('navigate to see contents of a chapter and topic, then go back to home', () => {
    ...
    cy.location('pathname').should('include', 'selection')
    cy.location('pathname').should('include', 'contents-of')
    ...
    cy.get('a').contains('Home').click()
    cy.location('pathname').should('not.include', 'selection')
    cy.location('pathname').should('not.include', 'contents-of')
  })
})